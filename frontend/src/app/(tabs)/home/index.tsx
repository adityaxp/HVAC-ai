...
const index = () => {
    ...
    const selectedHvac = useMemo(
        () =>
            hvacData?.find((unit) => unit.unit_id === selectedAlert?.unit_id) ??
            null,
            ...
            return (
                ...
                >
                    ...
                    <View style={styles.metaRow}>
                        ...
                        >
                            <ThemedText
                                style={[styles.chipText, { color: tone.fg }]}
                            >
                                {tone.label}
                            </ThemedText>
                        </View>
    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.header}>
                <ThemedText type="subtitle">HVAC Monitor</ThemedText>
                <Pressable
                ...
                >
                    <View
                        style={styles.alertButtonSurface}
                        pointerEvents="none"
                    >
                        {useLiquidGlass ? (
                            <GlassView
            ...
            >
                <View style={styles.sectionHeader}>
                    ...
                    <TouchableOpacity
                        onPress={() => router.push("/hvac-details")}
                    >
                        <ThemedText
                            type="smallBold"
                            style={styles.detailedViewText}
                        >
                            Detailed View
                        </ThemedText>
                    </TouchableOpacity>
                ...
                {loading || hasHVACItems ? (
                    ...
                    >
                        ...
                        >
                            HVAC health cards will appear here once data is
                            available.
                        </ThemedText>
                    </View>
                )}
                            ...
                            return (
                                ...
                                >
                                    <View style={styles.alertTopRow}>
                                        <SkeletonLoader
                                            style={styles.skeletonAlertUnit}
                                        />
                                        <SkeletonLoader
                                            style={styles.skeletonAlertStatus}
                                        />
                                    </View>
                                    <SkeletonLoader
                                        style={styles.skeletonAlertTitle}
                                    />
                                    <SkeletonLoader
                                        style={styles.skeletonAlertMessage}
                                    />
                                    <View style={styles.alertMetaRow}>
                                        <SkeletonLoader
                                            style={styles.skeletonAlertTime}
                                        />
                                    </View>
                                </View>
                            );
                    ...
                    ListEmptyComponent={
                        ...
                        >
                            ...
                            <ThemedText
                                ...
                                style={styles.emptyStateText}
                            >
                                You are all clear right now. New alerts will
                                show up here.
                            </ThemedText>
                        </View>
                    }
                    ...
                    {trendListData.map((item) =>
                        "skeleton" in item ? (
                            <View key={item.id} style={styles.trendRow}>
                                <SkeletonLoader
                                    style={styles.skeletonTrendDay}
                                />
                                <SkeletonLoader
                                    style={styles.skeletonTrendTrack}
                                />
                                <SkeletonLoader
                                    style={styles.skeletonTrendCount}
                                />
                            </View>
                        ) : (
