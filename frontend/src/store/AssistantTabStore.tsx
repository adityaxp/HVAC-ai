...
const INITIAL_MESSAGES: AssistantMessage[] = [
    {
        ...
        role: "assistant",
        text: "Hi, I'm your HVAC AI assistant. How can I help you today?",
        sender: "HVAC Assistant",
    },
];

const normalizeUnitId = (unitId: string) =>
    unitId.replace(/\s+/g, "_").toUpperCase();
...
export const useAssistantTabStore = create<AssistantTabState>((set) => ({
    ...
    sendMessage: async (unitId, message) => {
        ...
        try {
            const response = await AI_ASSISTANT_CHAT(
    ...
    resetChat: () =>
        set({ messages: INITIAL_MESSAGES, isReplyLoading: false, error: null }),
}));
